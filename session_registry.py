...
class SessionRegistry:
    ...
    def __init__(
        self,
        registry_dir: str = "/tmp/claude_sessions",
        socket_path: str = "/tmp/claude_socks/registry.sock",
...
if __name__ == "__main__":
    ...
    if test_mode:
        ...
        print("=" * 60)
        registry_dir = "/tmp/claude_sessions_test"
        socket_path = "/tmp/claude_socks_test/registry.sock"
    else:
        print("=" * 60)
        print("Session Registry - Production Mode")
        print("=" * 60)
        # Use environment variables or defaults
        registry_dir = os.getenv("REGISTRY_DATA_DIR", "/tmp/claude_sessions")
        socket_dir = os.getenv("SLACK_SOCKET_DIR", "/tmp/claude_socks")
